...
function InvoiceUploader() {
  ...
  const generateInvoice = async (data: any) => {
      ...
      <div style="font-family: Arial, sans-serif; background-color: #fff; padding: 20px; margin: 20px auto; max-width: 800px; border: 1px solid #ddd;">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            <div style="text-align: center;">
                ...
                <strong style="color: #333;">Date: ${date}/${month}/${year}</strong>
            </div>
        </div>
        ...
        <div style="padding-top: 20px; display: flex; justify-content: space-between;">
            <div style="width: 48%; font-size: 14px; line-height: 1.6; color: #333;">
                ...
                Invoice No: ${selectedCompany === 'wtl' ? `${id?.wtlId}/2025-26` : `A${id?.aimcabId}/2025-26`}
            </div>
            ${selectedCompany === 'wtl' ?
        ...
        <div style="padding-top: 20px;">
            ...
            <table style="width: 100%; border: 1px solid #000; padding: 10px; border-collapse: collapse; margin-top: 10px;">
                ...
                <tr>
                    <td style="padding: 8px;"><strong>Service Charge (5%):</strong></td>
                    <td style="padding: 8px;">${(5 / 100) * (+invoiceData.baseFare)}</td>
                </tr>
                <tr style="background-color: #f9f9f9;">
                ...
                <tr style="background-color: #f9f9f9;">
                    ...
                    <td style="padding: 8px;">${invoiceData.finalAmount}</td>
                </tr>
            </table>
        </div>
    ...
    setId(prevId => ({
      ...prevId,
      ...(selectedCompany === 'wtl'
        ? { wtlId: prevId.wtlId + 1 }
        : { aimcabId: prevId.aimcabId + 1 })
    }));
